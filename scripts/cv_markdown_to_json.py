...
def extract_author_info(config):
    ...
    if 'author' in config:
        ...
        if author.get('location'):
            ...
            author_info['location']['countryCode'] = author.get('countryCode', '')
        ...
        # Academic profiles
        if author.get('academia'):
            profiles.append({
                "network": "Academia.edu",
                "username": "",
                "url": author.get('academia')
            })
        ...
        if author.get('inspire-hep'):
            profiles.append({
                "network": "INSPIRE-HEP",
                "username": "",
                "url": author.get('inspire-hep')
            })
        
        if author.get('webofscience'):
            profiles.append({
                "network": "Clarivate: Web of Science",
                "username": "",
                "url": author.get('webofscience')
            })
        ...
        if author.get('scopus'):
            profiles.append({
                "network": "Scopus",
                "username": "",
                "url": author.get('scopus')
            })
        ...
        if author.get('gitlab'):
            profiles.append({
                "network": "GitLab",
                "username": author.get('gitlab'),
                "url": f"https://gitlab.com/{author.get('gitlab')}"
            })
